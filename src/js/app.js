...
getConfig("./src/config/default/preferences.json", "./src/config/default/data.json");
...
function renderizarListaFacultades(features) {
    ...
    function poblarUL(items) {
        lista.innerHTML = "";
        if (items.length === 0) {
            lista.innerHTML = `<li style="padding: 8px; color: #777; font-size: 13px; text-align: center;">Sin resultados</li>`;
            return;
        }
